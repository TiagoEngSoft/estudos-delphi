...
begin
  ...
  dmContasReceber.cdsContasReceber.CommandText := 'SELECT cr.numero_documento, cr.descricao, cr.parcela, cr.status, cr.valor_parcela, cr.valor_venda FROM "contas_receber" as cr WHERE 1 = 1' + FFiltroPesquisa;
